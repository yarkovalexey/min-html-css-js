...
foreach (glob(basename($dir)."/*".$expansion) as $filename)
{
	$filename = basename($filename, $expansion).",";
	$GET_files = $GET_files.$filename;
}
$GET_files = substr($GET_files, 0, -1);

//Получаем массив файлов
$files = explode(',', $GET_files);
